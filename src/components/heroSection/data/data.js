export const data ={
    ...
    ul2:`Students from Tier-3 colleges have Cracked 10LPA+offer in the last 10 months`,
    ul3:`850 hours structured course on DSA(OA + Interview + CP) with 24 *7 doubt Support `,
